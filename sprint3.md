...
### Jotham
>I used AI throughout the project mainly to support my frontend development and to help me learn concepts I was not fully comfortable with at the beginning. I was responsible for many of the main UI components, including the Card component, the Garage page, TradeCard, and several of the interfaces used throughout the app. I also wired these components into their respective pages and ensured they worked together in a clean and consistent way. While doing this, I often ran into questions about React patterns such as context usage, custom hooks, and how state should move between components. AI helped me understand these ideas by breaking them down and giving examples that made the behavior easier to visualize and apply.
>
>AI was especially helpful when dealing with the connection between my pages and the existing context files, services, and API calls. Sometimes the errors involved confusing TypeScript messages, incorrect prop shapes, or unexpected behavior when multiple components interacted. AI guided me in pinpointing what the issue actually was and suggested possible approaches, which made the debugging process faster. Even when AI provided code samples, I treated them as references and rewrote the logic myself to match our style, structure, and design tokens.
>
>Overall, AI improved my workflow by speeding up learning, helping me clarify unfamiliar concepts, and supporting me during complex debugging. It did not replace my own work, but it allowed me to produce cleaner, more reliable components and understand the frontend architecture at a deeper level.
